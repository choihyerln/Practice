		...
		<div class="py-5">
			...
			<div class="text-center">
				...
				<div>
					...
					<a dataype="kakao" href="#"> <svg width="48" height="48"
			...
			<form action="/user/join" method="post">
				...
				<!-- 이름 -->
				<div>
					<label>* 이름</label> <br> <input class="form-control" value=""
						name="uname" placeholder="ex) 홍길동" required>
				</div>
				...
				<div>
					...
					<input type="text" id="id" name="id" class="form-control"
						oninput="checkId()" placeholder="아이디" value="" required>
					<!-- id ajax 중복체크 -->
				...
				<div>
					<label>연락처</label> <br> <input type="number"
						class="form-control" value="" name="tel"
				...
				<div>
					...
					<input type="number" class="form-control" value="" name="birthDate"
				...
				<div>
					<label>월 급여 또는 용돈</label> <br> <input type="number"
						class="form-control" value="" name="pay"
						placeholder="급여나 용돈을 입력해주세요">
				</div>

				<!-- 출발지 -->
				<div>
					<label>출발지</label> <br> <input class="form-control" value=""
						name="departures" placeholder="">
				</div>

				<!-- 목적지 -->
				<div>
					<label>목적지</label> <br> <input class="form-control" value=""
